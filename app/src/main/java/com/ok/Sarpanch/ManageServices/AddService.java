...
public class AddService extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //---------
        service_name_et = findViewById(R.id.id_service_et_service_name);
        submitBtn = findViewById(R.id.id_service_btn_submit);
        //---------
        ...
        submitBtn.setOnClickListener(v -> {
            if (isValid()) {
                ...
                long generatedServiceID = leftLimit + (long) (Math.random() * (rightLimit - leftLimit));
                String serviceID = String.valueOf(generatedServiceID);
                progressDialog.show();
                submit(serviceID, sharedPref.getVillageId());
            }
        });
    }
    ...
    void submit(String serviceID, String villageId) {
            ...
            public void onPageFinished(WebView view, String url) {
...

                {
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        StringBuilder deptName = new StringBuilder(service_name_et.getText().toString().trim());
                        deptName.setCharAt(0, Character.toUpperCase(deptName.charAt(0)));

                        Map<String, String> params = new HashMap<>();
                        params.put("service_id", serviceID);
                        params.put("service_name", deptName.toString());
        ...
        webViewRequest.loadUrl(URLs.URL_ADD_SERVICE);
    }
